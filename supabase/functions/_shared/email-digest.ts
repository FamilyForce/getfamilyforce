...
const MONTH_CONTENT: Record<number, MonthContent> = {
  ...
  11: { theme: '🚶 This month: cruising along furniture, first words getting specific, and the first dental visit.', dyk: 'Babies say \'mama\' and \'dada\' as sounds around 9 months — but using them **specifically** (mama when looking at mum, dada when looking at dad) typically locks in by 12 months. That specificity is the milestone, not the sound.', opening: 'Eleven months. She\'s cruising the furniture — the last step before walking. Here\'s what matters before the first birthday.', context: 'Eleven months: the walk is coming. You can see it in her eyes every time she lets go.', closing: 'One month to the first birthday. It goes fast — and then it really goes fast. — Jack, Founder @ FamilyForce' },
  ...
  14: { theme: '👉 This month: pointing and shared attention, walking as locomotion, and body parts.', dyk: 'Pointing to share interest — then looking back to check your reaction — is more important than first words as an early communication milestone. It\'s called **declarative pointing** and it\'s a key marker on the M-CHAT autism screen.', opening: 'Fourteen months. She\'s pointing — and looking back at you after she points. That\'s joint attention, and it matters more than almost any other milestone right now.', context: 'Fourteen months: a walker who points. That\'s a communicator in the making.', closing: 'When she points and looks back at you — respond every time. That\'s the lesson she\'s practising. — Jack, Founder @ FamilyForce' },
  ...
  30: { theme: '🩺 This month: the 30-month checkup, the crib-to-bed transition, and the potty finish line.', dyk: 'Moving from crib to bed **too early** is one of the most common causes of sleep regression in the second and third years. The crib is a boundary. Keeping it until age 3 — unless she\'s climbing out — makes bedtime more predictable for everyone.', opening: 'Thirty months. Two and a half years. The 30-month visit was added to the AAP schedule specifically because the gap between 24 and 36 months was too long.', context: 'Thirty months: the halfway point between the 2-year and 3-year checkups — and one of the most useful.', closing: 'Two and a half. The language has come so far. Come prepared to the 30-month visit. — Jack, Founder @ FamilyForce' },
  ...
  33: { theme: '🌟 This month: imaginary friends, storytelling, and following complex instructions.', dyk: 'Children who regularly **tell stories** about their own experiences show stronger reading comprehension and writing ability at age 6 and 7. Storytelling builds the narrative scaffolding that books are built on. The dinner table is the classroom.', opening: 'Thirty-three months. She may have an imaginary friend — or be on the verge of inventing one. Research shows this is a very good sign.', context: 'Thirty-three months: imagination is at full power. Harness it.', closing: 'The imaginary friend is practising social skills. Let her. — Jack, Founder @ FamilyForce' },
