...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // 4. Build invite URL — plain landing page with invite params in query string.
    //    The invitee clicks this, enters their email, and receives a PKCE magic link
    //    (scanner-safe). We do NOT use admin.generateLink here — raw OTP URLs in
    //    emails are consumed by iOS Mail / Gmail scanners before the user clicks them.
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:480px;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 24px rgba(110,78,214,0.10);">
        ...
        <tr><td style="padding:36px 40px 32px;">
          ...
          <p style="margin:0;font-size:13px;color:#8B85A8;line-height:1.65;">
            Don't have a FamilyForce account? You'll be guided to create one when you tap the button above.
          </p>
