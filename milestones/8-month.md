# 8 Months: Mobility Is Arriving and the Texture Window Is Almost Closed
...
Second: the texture window. It closes at 9 months. If soft finger foods aren't part of daily meals yet, this is your last easy moment to change that.

## Motor Milestones at 8 Months

- **Crawling or pre-crawling mobility.** Most babies crawl between 7 and 10 months. Army crawl, bottom scoot, and rocking on hands and knees all count as progress. What matters is the intent to move independently, not the method.
- **Sitting independently — fully established.** Both hands free, stable balance. Not sitting independently by 8 months is a flag for the next well-child visit.
- **Pulling to stand — beginning.** Using furniture or your hands to push from sitting to standing. The beginning of the path to walking.
- **Pincer grasp — developing.** Progressing from whole-hand raking toward thumb-and-index-finger pickup. The true pincer grasp solidifies 9–10 months.
- **Bilateral hand use.** Using both hands together — holding a toy in one while banging with the other. If your baby only ever uses one hand, mention it at the next visit.
