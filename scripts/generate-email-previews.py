...
MONTH_CONTENT = {
    ...
    10: {"theme":"🐟 This month: the last allergen, peek-a-boo for the brain, and the milestone that changes your safety checklist.",
         ...
         "opening":f"{CHILD_NAME} is 10 months old. She's pulling up to stand, and the last major allergen introduction is this month.",
    ...
    27: {"theme":"🚽 This month: potty readiness signs, catching a ball, and the 3-year speech clarity benchmark.",
    ...
    29: {"theme":"🏫 This month: what preschool readiness really means, balance, and counting 1–5 with meaning.",
    ...
    34: {"theme":"✏️ This month: copies a circle, gratitude at the table, and the first wheels.",
